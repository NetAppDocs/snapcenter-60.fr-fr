...
. Entrez le nom du groupe de ressources dans la zone de recherche ou cliquez sur image:../media/filter_icon.png["Icône de filtre"], puis sélectionnez la balise.
+
