...
* Pour plus d'informations sur les limitations de l'opération de fractionnement de clone, reportez-vous à la http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-vsmg/home.html["Guide de gestion du stockage logique ONTAP 9"^].
