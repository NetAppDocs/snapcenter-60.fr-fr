...
---
= Installez les modules de plug-in SnapCenter pour Linux, Windows ou AIX sur plusieurs hôtes distants à l'aide d'applets de commande
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez installer simultanément les modules de plug-in SnapCenter pour Linux, Windows ou AIX sur plusieurs hôtes à l'aide de l'applet de commande PowerShell Install-SmHostPackage.
