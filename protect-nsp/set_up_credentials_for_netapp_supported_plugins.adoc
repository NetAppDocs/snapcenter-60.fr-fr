...
* Hôtes Linux ou AIX
+
Vous devez configurer des informations d'identification pour l'installation de plug-ins sur des hôtes Linux ou AIX.
...
* Plug-ins d'applications pris en charge par NetApp
+
...
NOTE: Applicable aux utilisateurs Linux et AIX uniquement.
