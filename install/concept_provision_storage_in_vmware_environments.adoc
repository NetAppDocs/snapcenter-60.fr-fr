...
Le disque partagé n'est pas créé à l'aide du Plug-in for Windows. Vous devez créer le LUN partagé, puis l'ajouter à chaque machine virtuelle du cluster.



=== Informations associées

Consultez  https://techdocs.broadcom.com/["Broadcom Documentation technique"^] et recherchez la documentation sur le clustering de machines virtuelles sur des hôtes physiques et la création de LUN FC RDM partagés pour les clusters Microsoft.
