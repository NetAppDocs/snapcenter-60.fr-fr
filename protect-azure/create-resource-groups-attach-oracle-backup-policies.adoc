...
.. Sélectionnez la stratégie pour laquelle vous souhaitez configurer votre planification de vérification, puis cliquez sur *image:../media/add_policy_from_resourcegroup.gif[""].
