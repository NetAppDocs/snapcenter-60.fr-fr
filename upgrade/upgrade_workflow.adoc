...
IMPORTANT: Par exemple, si vous utilisez SnapCenter version 4.9 et que vous souhaitez effectuer une mise à niveau vers 6.0.1, vous devez d'abord mettre à niveau vers 5.0, puis effectuer une mise à niveau par déploiement vers 6.0.
