...
. Lancer PowerShell.
. À l'invite de commande, entrez : `Open-SMConnection`
. À l'invite de commande, entrez : `Remove-SmJobs`
. Dans le volet de navigation de gauche, cliquez sur *moniteur*.
