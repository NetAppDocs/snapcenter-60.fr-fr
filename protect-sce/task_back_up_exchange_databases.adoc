...
+
Dans la page Ressources, l' image:../media/not_supported_icon.png["stockage non pris en charge"] icône indique que la base de données se trouve sur un stockage non-NetApp.
