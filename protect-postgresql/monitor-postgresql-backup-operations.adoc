...
---
= Surveillez les opérations de sauvegarde PostgreSQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Surveillez les opérations de protection des données sur les clusters PostgreSQL dans le volet activité
