...
+
Si aucune stratégie existante ne répond à vos exigences, vous pouvez créer une nouvelle stratégie en cliquant sur * *image:../media/add_policy_from_resourcegroup.gif["icône plus"]pour lancer l'assistant de stratégie.
...
.. Dans la section configurer les planifications pour les stratégies sélectionnées, cliquez sur * *image:../media/add_policy_from_resourcegroup.gif["icône plus"]dans la colonne configurer les planifications de la stratégie pour laquelle vous souhaitez configurer le planning.
